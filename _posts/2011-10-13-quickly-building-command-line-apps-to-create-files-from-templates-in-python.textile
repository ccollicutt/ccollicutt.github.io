...
First, let me say that I am not an expert in Python. :) That said, I have been working on a "script":http://github.com/curtisgithub/kicker for a while now that creates a kickstart file from a command line application that uses:
...
<pre>
<code>$ git clone git@github.com:curtisgithub/cli-template-generator.git
