...
I would like to work in an organization that fosters diversity in its staff and works hard to maintain that diversity, not just in terms of gender and ethnicity, but also in terms of what staff do outside their work life.
...
h2. Projects
<p></p>
* Lead developer on an open source "virtual lab":https://github.com/curtisgithub/labinski/tree/sqlalchemy (ie. "DaaS":http://en.wikipedia.org/wiki/Desktop_virtualization) based on OpenStack[2]
...
* Unix Systems Administrator - Production Services & Research - Large Online and Distance University - Oct 2007 to April 2011
