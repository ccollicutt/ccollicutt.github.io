...
h2. Projects
<p></p>
* Lead developer on an open source "virtual lab":https://github.com/curtisgithub/labinski/tree/sqlalchemy (ie. "DaaS":http://en.wikipedia.org/wiki/Desktop_virtualization) based on OpenStack[2] called _The Labinski_!
