...
Currently I am working on deploying OpenStack Swift. I am using Vagrant and virtual machines to create an ansible playbook to deploy and manage Swift. To do that I have been using sparse disks to mimic real disks without actually having all the disk space required.
