...
p(meta). 15 October - 2012 - San Diego

!https://raw.github.com/curtisgithub/curtisgithub.github.com/master/img/openstack_hotel.jpg!

h1. OpenStack 2012 Summit
...
The first session I attended was by "Cole Crawford":https://twitter.com/coleinthecloud of the "Open Compute Foundation":http://opencompute.org/. Basically this was an overview of the history of things like the 19" rack (it came from waaaaay back from the train system) and how we need to change our standards to allow things like interoperability and other good things.
...
Further, considering that libraries and researchers  (ie. their respective Universities and organizations), are supposed to work together it would make sense to be able to have some kind of interoperability between object storage clouds, private or otherwise, even if it's just for some separation geography-wise.
...
!https://raw.github.com/curtisgithub/curtisgithub.github.com/master/img/openstack_summit_2012_bar.jpg!
