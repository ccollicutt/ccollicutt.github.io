...
This is a central server that can be used to access all the Linux/Unix servers (via ssh) and try to automate with custom scripts or things like "pdsh":https://code.google.com/p/pdsh/, "chef":http://www.opscode.com/chef/, "puppet":http://www.puppetlabs.com/, "fabric":http://www.fabfile.org, ect.
