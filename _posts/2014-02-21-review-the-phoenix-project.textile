...
Recently I have been reading books about DevOps--its (short) history and (old) influences. That meant reading _The Goal_ by Eliyahu M. Goldratt, which is a business novel about managing a factory using lean manufacturing concepts. _The Goal_ is heavily referenced in _The Phoenix Project_, and in fact Kim et al's book copies (in a good way) the style and format of Goldratt's book. (Though it leaves out much of the home life drama of the main character that is included in Goldratt's book.)

In short the novel, which is in the form of an allegory, is about Bill Palmer, an IT manager who is suddenly promoted to VP of IT Operations in a large, struggling auto parts manufacturing company. Every IT department and project is a mess and will be familiar to anyone who has worked in the field. The book also uses the same Socratic method as _The Goal_ in that there is an eccentric Guru character, Erik, who helps Bill along the path towards success using questions that force critical thinking along the DevOps paradigm.

The first part of the book is really about connecting with the reader. 
...
Coming from an information security background, I was struck by how the CISO was depicted in the book, but I was not surprised, because I've also read Kim et al's book _Visible Ops Security_, in which statements such as the following are made:
...
In the context of the _Visible Ops Security_ book I absolutely agree with the above statement, and have always felt that something needed to change in information security in order for it to become more aligned with the business, and instead of saying no all the time, be able to say yes to new, valuable projects.

In _The Phoenix Project_ the Chief Information Security Officer (CISO), John, hits rock bottom after a series of security project failures. In fact there is a scene with him extremely drunk in a bar, with all his belongings packed in a U-haul attached to his Volvo (of course he drives a Volvo). The VP IT Operations gets him a cab home and afterwards John doesn't come into the office for two weeks. When he finally returns to work he is a "new man", complete with a shaved head, new attitude, and "Euro discotheque" style. While the transformation is a bit obvious, this is an allegorical novel, and the point's well taken.
...
In the end, _The Phoenix Projet_ is a good read which is differentiated by its storytelling approach, and it _is_ about DevOps, which likely makes it required reading for anyone in, or wanting to know more about, the field.