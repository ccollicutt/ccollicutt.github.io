...
* 3x ESXI hosts - each are a 1U Supermicro server with 128GB memory on a X9DRI-LN4F+ motherboard
...
* [Used to run NSX](https://serverascode.com/2020/07/20/vsphere-7-with-kubernetes-nsxt-3.html) but it's currently not deployed in this version lab
