...
%{color:red}Update:% Please note that this post is getting a bit old. Currently I am running these IBM FusionIO drives on RHEL 6. I'll be posting about that and a few other things in the next short while.
