...
The amount of data an organization has to store never seems to go down, only up up UP!--probably at least 50% per year. High-end, so called Enterprise storage, can cost between $50K-$100K per terabyte, where K is thousands. 
