...
!https://raw.github.com/curtisgithub/curtisgithub.github.com/master/img/coffee_abyss.jpg!

_(sometimes the coffee abyss looks into you!)_

p(meta). 16 Nov - 2013 - Edmonton!
...
<pre>
<code>
package_cache_srv$ sudo apt-get install apt-cacher-ng
...
<pre>
<code>
vm_1$ cat /etc/apt/apt.conf.d/01proxy
