...
_UPDATE: I'm still working on the numbers at the end with regards as to how much memory is actually being saved. I'm still trying to figure out what means what. :)_
...
Unfortunately, by my calculations that is only ~1.7GB saved.
