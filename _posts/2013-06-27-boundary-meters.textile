...
_Please note that both boundary and ansible move pretty fast, so it's likely that things will have changed even by the time I post this. :)_
...
- name: ensure boundary repository is installed
  action: apt_repository repo='https://apt.boundary.com/ubuntu/ precise universe'
