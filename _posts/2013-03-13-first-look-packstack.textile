...
One of the suggestions was to follow what "PackStack":https://github.com/stackforge/packstack has done--it's based on puppet--and port it over to Ansible. (NOTE: I'm not even sure that is the right git repo, things are moving so fast!) 
