...
p(meta). 12 September - 2011 - Edmonton
...
Note that I haven't shown any memory usage from the firewall, but the small boxes have 512MB of RAM and even at 200K sessions the memory usage only went up very slightly so I don't think it's a constrained for memory reasons.
