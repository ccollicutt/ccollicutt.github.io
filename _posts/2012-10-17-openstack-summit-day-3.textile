...
So Ken goes through his slides. Mentions VDI and that VDI is hard! Capex, buy more hardware, can't fit it in their data center, SAN administrators, etc. VDI is tough.

The point of the session is that VDI is a three billion dollar market and is a new market that OpenStack can access. Further he talks about the fact that running a desktop resource manager/broker on top of OpenStack can create operational and other cost savings. It also allows and organization like Desktone to focus on user experience versus running infrastructure.
