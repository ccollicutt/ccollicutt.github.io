...
!https://raw.github.com/curtisgithub/curtisgithub.github.com/master/img/ipmi_supermicro.png!

_(screenshot of supermicro bios via ipmi sol--ie. text based)_
...
<pre>
<code>
terminal_1$ ipmitool -I lanplus -H 10.0.0.10 -U ADMIN -P ADMIN sol activate
</code>
</pre>
...
<pre>
<code>
terminal_2$ ipmitool -I lanplus -H 10.0.0.10 -U ADMIN -P ADMIN chassis power off
</code>
</pre>
...
<pre>
<code>
terminal_2$ ipmitool -I lanplus -H 10.0.0.10-U ADMIN -P ADMIN chassis bootdev bios
</code>
</pre>
...
<pre>
<code>
terminal_2$ ipmitool -I lanplus -H 10.0.0.10 -U ADMIN -P ADMIN chassis power on
</code>
</pre>
...
To exit, hit enter and then the ~ key twice, and finally a ".". If you just enter one tilde then when you exit you will exit right out of your ssh session to the server that has access to the management network on which the IPMI interfaces are places, assuming that is, you have a secure management network.