...
* No 2-factor authentication to the admin panel, so if your login was compromised then your server is owned. I'm not even sure if the higher end OVH service provides this, not that they should differentiate on that feature.
