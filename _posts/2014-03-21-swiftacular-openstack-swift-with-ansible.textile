...
I don't know why, but much of the OpenStack documentation, especially around Keystone, which is the authentication system, avoids discussing how to deploy SSL/TLS enabled services. 
