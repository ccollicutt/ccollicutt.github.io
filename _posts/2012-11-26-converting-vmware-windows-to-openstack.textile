...
Currently we are in the process of moving the backed of our VCL system from a VMWare ESXi based cluster to OpenStack (Essex to be precise.) There are a lot of reasons for this move, and I won't get into them here.
...
Fortunately RedHat provides a system called virt-v2v. This allows the cross-conversion of several different types of hypervisors.
...
# Convert the raw/vmdk image to qcow2 using "qeum-img".
