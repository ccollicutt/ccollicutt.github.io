...
Recently I deployed "packstack":http://serverascode.com/2013/03/13/first-look-packstack.html via vagrant and *virtualbox*, and I wanted to do the same with vmware_fusion, but I ran into a few problems.
