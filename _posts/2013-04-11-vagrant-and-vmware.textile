...
This is a new one...now this can't be virtualbox's fault. I have no idea what to do with this issue...
...
I can't seem to find anything on removing or changing vmnets in fusion, but it's only been an hour or so since this happened.
